    ...
    def createJSON(self, jsonFile):
        ...
        for cluster in self.associatedClusters:
            ...
            if cluster[0] == ['address']:
                ...
                data['amount']['depositDue'] = float(words[-1][2:].replace(',', ''))
            elif cluster[0] == ['date']:
        ...
        with open("C:/Users/andre/Desktop/gep/AI_Domain_Models/backend/extract_text/JSON/" + data['invoiceNum'] + ".json", "w") as outfile:
