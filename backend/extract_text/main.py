...
def extract_text(file, gep_ph, acces_token):
    # acces_token = \
    ...
    file = r'C:/Users/andre/Desktop/gep/AI_Domain_Models/Images/resized_invoice.jpg'
    ...
    nameJSON = process_text.createJSON('C:/Users/andre/Desktop/gep/AI_Domain_Models/backend/extract_text/JSON/structure.json')

    with open('C:/Users/andre/Desktop/gep/AI_Domain_Models/backend/extract_text/JSON/' + nameJSON) as json_file:
